...
Gem::Specification.new do |spec|
  spec.name          = "bootstrap_form_image_field"
  spec.version       = BootstrapFormImageField::VERSION
  spec.authors       = ["Ouvrages"]
  spec.email         = ["contact@ouvrages-web.fr"]

  spec.summary       = "BootstrapFormBuilder extension"
  spec.description   = "Add an image_field to Bootstrap FormBuilder"
  ...
  spec.add_runtime_dependency "dragonfly", '>= 1.0.12'
end
